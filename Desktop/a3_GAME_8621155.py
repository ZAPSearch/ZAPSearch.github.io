...
def deal_cards(deck):
     ...
     for d in range (0, len(deck), 2):
         dealer.append(deck[d])
     for o in range (1, (len(deck)-1), 2):
         other.append(deck[o])
...
def get_valid_input(n):
     ...
     # COMPLETE THE BODY OF THIS FUNCTION ACCORDING TO THE DESCRIPTION ABOVE
     # YOUR CODE GOES HERE
     user_input = int(input("Enter a number greater than or equal to 1 and less than n:"))
